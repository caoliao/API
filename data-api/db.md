...
如果你需要连接官方数据库，制作自定义报表，[查看报表示例](https://sugar.aipage.com/report/r_1013e-17hzobcu-kbgmgv/86b0d1a98d22b5afe789e16c0502f69d)

由于涉及了基础的数据库（SQL）操作与BI工具操作，具有一定的使用门槛，使用前请掌握基础的操作能力。[查看报表制作教程](./data-api/BI/api-with-sugar.md)
...
| tpl_code_id | int | 批量模板的唯一标识<br>如果非模板生码，tpl_code_id与code_id相同 | 54349863 |
...
| 字段名 | 类型 | 说明<div style="width:100px"></div> | 示例 |
|--------|------|------|------|
...
| 事件<div style="width:100px"></div> | 是否推送<div style="width:60px"></div> | 影响的数据表 | 数据表现 |
|------|----------|--------------|----------|
...
我们的数据库为Mysql，连接时数据库类型选择为Mysql，[查看操作详情](https://zhuanlan.zhihu.com/p/410611306)
